...
## Active Technologies
- Python 3.12+ (backend), TypeScript 5.x (frontend) + FastAPI 0.115+, Pydantic v2, SQLAlchemy 2.x (async), Alembic, Next.js 15 (App Router), TailwindCSS, shadcn/ui (005-inventory-management)
- PostgreSQL 16 LTS (Docker Compose in dev; Neon PostgreSQL in production) (005-inventory-management)
