"""Purchase RBAC permission check (Epic 9A Phase 10, T140).

Resolves whether a user holds a specific purchase permission code in a
...
def user_has_purchase_permission(
    db: Session,
    company_id: UUID,
    user_id: UUID | None,
    permission_code: str,
